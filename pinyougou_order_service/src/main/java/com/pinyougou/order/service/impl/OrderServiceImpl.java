...
public class OrderServiceImpl implements OrderService {
    ...
    public void add(TbOrder order) {
        ...
        //1.从redis中提取购物车列表 按照商家ID生成订单
        System.out.println("从redis读取购物车的信息。。。");
        //购物车订单
        ...
        for (Cart cart : cartList) {
            ...
            tbOrder.setSellerId(cart.getSellerId());//商家ID,应该从当前的商品来获得商家ID
        ...
        //3.清除redis中的购物车
        System.out.println("清除购物车redis中的数据。。。");
